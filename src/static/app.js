        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-block">
            ...
            ${details.participants.length
              ? `<ul>${details.participants.map((participant) => `<li><span>${participant}</span><button class="delete-participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Remove ${participant}">&times;</button></li>`).join("")}</ul>`
